...
%package -n     python2-%{sname}-tempest
Summary:        %{sname} tempest plugin

Requires:       python2-%{sname} = %{version}-%{release}

%description -n python2-%{sname}-tempest
%{common_desc}

It contains the tempest plugin for Patrole.
...
%package -n     python3-%{sname}-tempest
Summary:        %{name} tempest plugin

Requires:       python3-%{sname} = %{version}-%{release}

%description -n python3-%{sname}-tempest
%{common_desc}
